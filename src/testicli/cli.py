...
from testicli.models import QualitySeverity, TestStatus, TestType
...
def review(
    ...
    # Only review tests that passed and have code
    ...
    for planned_test in reviewable:
        ...
        if fix and not result.passed and llm is not None:
            ...
            for attempt in range(1, max_fix_attempts + 1):
                ...
                # Write fixed code and re-run test to ensure it still passes
